        ...
        <div class="col-lg-8 col-md-12">
            <div class="card">
                <div class="card-header bg-light d-flex justify-content-between">
                    ...
                    <a href="{{ route('show.unread.message') }}" class="btn btn-info">See Unread Message</a>
                </div>
                <div class="card-body">
                    @if (session('success'))
    ...
    <td>
        <div class="actioncontainer d-flex m-2 justify-content-between">
            <div class="action1">
                ...
                <a class="btn btn-outline-danger btn-sm" href="{{ route('delete.read.message', $item->id) }}" onclick="return confirm('Are you sure?')">Delete</a>
            </div>
